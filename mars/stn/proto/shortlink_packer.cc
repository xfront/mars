...
void (*shortlink_pack)(const std::string& _url, const std::map<std::string, std::string>& _headers, const AutoBuffer& body, const AutoBuffer& extension, AutoBuffer& _out_buff, shortlink_tracker* _tracker)
= [](const std::string& _url, const std::map<std::string, std::string>& _headers, const AutoBuffer& body, const AutoBuffer& extension, AutoBuffer& _out_buff, shortlink_tracker* _tracker) {
	...
	_out_buff.Write(body.Ptr(), body.Length());
};
