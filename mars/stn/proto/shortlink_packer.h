...
public:
    ...
    extern void (*shortlink_pack)(const std::string& _url, const std::map<std::string, std::string>& _headers, const AutoBuffer& body, const AutoBuffer& extension, AutoBuffer& _out_buff, shortlink_tracker* _tracker);
